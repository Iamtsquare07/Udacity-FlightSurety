...
contract FlightSuretyApp {
    ...
    */   
    ...
    function fundAirline() external requireRegisteredAirlineCaller{
    ...
    */  
    ...
    event FlightRegistered(address indexed airlineAddress, string flight, uint256 departureTime);

     event Insurancepurchased (address indexed passengerAddress, uint256 amount);

    event InsurancePayout(address indexed airlineAddress, string flight, uint256 departureTime);
...
// region ORACLE MANAGEMENT
    ...
    // Returns array of three non-duplicating integers from 0-9
    function getRandomInde (address account) internal returns (uint8){
        uint8 maxValue = 10;
